(function() {
    ...
    p._keyRecord = [], p._enabled = !0, p.initialize = function(code, timeThreshold) {
        if (code === undefined) throw "SecretCode requires a single attribute of an array of keyCodes";
        this._stage = document, this._code = code, this._timeThreshold = timeThreshold || 3e3, 
        this._timeoutTimer = null, this.enabled = !0;
    }, Object.defineProperty(p, "enabled", {
        get: function() {
            return this._enabled;
        },
        set: function(enabled) {
            this._enabled = enabled, this._stage.onkeyup = null, this._stage.onkeydown = null, 
            this._clearTimer(), enabled && this.reset();
        }
    }), p.reset = function() {
        this._stage.onkeyup = null, this._stage.onkeydown = this._onStartCodeInput.bind(this), 
        this._keyRecord = [], this._clearTimer();
    }, p._onTimeout = function() {
        this.trigger(SecretCode.TIMEOUT), this.reset();
    }, p._onStartCodeInput = function(ev) {
        ev.keyCode == this._code[0] && (this._stage.onkeydown = null, this._stage.onkeyup = this._onCodeInput.bind(this), 
        this._timeoutTimer = setTimeout(this._onTimeout.bind(this), this._timeThreshold));
        ...
        this.reset(), this._timeoutTimer = null, this._keyRecord = null, this._code = null, 
        this._stage.onkeyup = null, this._stage.onkeydown = null, this._stage = null;
